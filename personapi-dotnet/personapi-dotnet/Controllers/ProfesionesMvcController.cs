...
{
    public class ProfesionesMvcController : Controller
    {
        private readonly PersonaDbContext _context;

        public ProfesionesMvcController(PersonaDbContext context)
        {
            _context = context;
        }
        ...
        // GET: ProfesionesMvc/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ProfesionesMvc/Create
