...
public partial class PersonaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666DBF785ADC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83F37F6668D");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D65F8D82C20");
